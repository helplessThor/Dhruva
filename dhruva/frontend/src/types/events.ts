...
export const LAYER_CONFIGS: LayerConfig[] = [
    ...
    { id: 'fire', label: 'Active Fires', icon: 'fire', color: '#ff2d20', enabled: true },
    { id: 'conflict', label: 'Conflicts', icon: 'conflict', color: '#ff0055', enabled: true },
    { id: 'aircraft', label: 'Aircraft', icon: 'aircraft', color: '#00bfff', enabled: true },
    { id: 'marine', label: 'Marine', icon: 'marine', color: '#0077cc', enabled: true },
    ...
    { id: 'economic', label: 'Economic', icon: 'economic', color: '#10b981', enabled: true },
    { id: 'military', label: 'Military Zones', icon: 'military', color: '#4ade80', enabled: true },
