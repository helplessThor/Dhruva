...
const ICON_PATHS: Record<EventType, (c: string) => React.ReactNode> = {
    ...
    // Airspace Closures
    notam: (c) => (
        <path d="M8 1.5C4.4 1.5 1.5 4.4 1.5 8s2.9 6.5 6.5 6.5 6.5-2.9 6.5-6.5S11.6 1.5 8 1.5zm0 1.5c1.2 0 2.3.4 3.2 1l-7.7 7.7C2.9 10.8 2.5 9.4 2.5 8c0-3 2.5-5.5 5.5-5.5zm0 11c-1.2 0-2.3-.4-3.2-1l7.7-7.7c.6 1 1 2.3 1 3.7 0 3-2.5 5.5-5.5 5.5z" fill={c} />
    ),
    // News: minimal globe/broadcast icon
    news: (c) => (
        <>
            <circle cx="8" cy="8" r="6" fill="none" stroke={c} strokeWidth="1.5" />
